...
public class SMSService {
    ...
    @Value("${external.coolsms.paymentalarmid}")
    private String paymentAlarmId;
    ...
    public void setPaymentAlarm(SuccessfulBidDto successfulBidDto){
        KakaoOption kakaoOption = new KakaoOption();
        // disableSms를 true로 설정하실 경우 문자로 대체발송 되지 않습니다.
        // kakaoOption.setDisableSms(true);
        ...
        kakaoOption.setPfId(channelId);
        // 등록하신 카카오 알림톡 템플릿의 templateId를 입력해주세요.
        kakaoOption.setTemplateId(paymentAlarmId);
        ...
        */
        HashMap<String, String> variables = new HashMap<>();
        variables.put("#{art_name}", successfulBidDto.getArt_name());
        variables.put("#{time}", successfulBidDto.getTime());
        variables.put("#{art}", successfulBidDto.getArtPk());
        variables.put("#{user}", successfulBidDto.getUserPk());
        kakaoOption.setVariables(variables);
